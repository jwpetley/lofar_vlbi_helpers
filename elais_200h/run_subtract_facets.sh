...
export MSDATA=/project/wfedfn/Share/jdejong/output/ELAIS/${LNUM}/${LNUM}/applycal
export MODELS=/project/wfedfn/Share/jdejong/output/ELAIS/${LNUM}/${LNUM}/ddcal/selfcals/imaging
